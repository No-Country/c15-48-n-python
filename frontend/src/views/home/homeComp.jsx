...
const HomeComp = () => {
  ...
  return (
    <div className="flex flex-col items-center md:relative">
      <div className="flex items-center h-20 w-full justify-between max-w-4xl md:sticky md:top-0 md:bg-dark-black md:z-10">
        <div className="w-1/2 h-12 flex items-center md:w-full md:justify-center mx-6">
          <img src={MaskotApp} className="MaskotApp" />
        </div>
      </div>
