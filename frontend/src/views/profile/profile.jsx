  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="flex justify-between px-8 pt-8 md:max-w-4xl w-full">
        ...
        <button onClick={handleMenu}><img src={DotsVertical} alt="menú de tres puntos" /></button>
        ...
        <div className="font-custom text-white bg-dark-gray absolute px-4 py-3 rounded-xl right-6 top-14 w-28 text-xs text-center">
          <button className="flex items-center"><img className="mr-2 w-4" src={banIcon} alt="Ícono de bloquear" />Bloquear</button>
          <button className="flex items-center mt-2"><img className="mr-2 w-4" src={reportIcon} alt="Ícono de megáfono" />Reportar</button>
        </div>
      )}
      </div>
