...
import PublishWeb from "../views/Publish/PublishWeb.jsx";
...
export default function Webnavbar() {
  ...
  return (
    <div className="relative">
      <div className="h-screen flex-col lg:flex-row border-r-2 lg:w-96 border-gray hidden md:flex pr-8">
            ...
            <div className="flex flex-col w-full gap-5 text-xl">
              <NavLink to="/" className="w-full flex pl-5">
                <li
                  className={
                    isActive("/") && !postModal
                      ? "flex items-center gap-3 p-2 w-40 text-social-pink"
                      : "flex items-center gap-3 p-2 w-40 opacity-20"
                  }
                >
                  <svg
                    width="36"
                  ...
                  >
                    <g opacity="0.988636">
                      <path
                        ...
                        fill={isActive("/") && !postModal ? "#F62E8E" : "#ECEBED"}
                      />
                      <path
                        d="M3.62549 16.6697L16.2031 3.98035"
                        stroke={isActive("/") && !postModal ? "#F62E8E" : "#ECEBED"}
                        stroke-width="2"
              ...
              <NavLink to="/explore" className="w-full flex pl-5">
                ...
                >
                  <svg
                    ...
                    height="36"
                    viewBox="0 0 36 36"
                    fill={isActive("/explore") && !postModal ? "#F62E8E" : "#ECEBED"}
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
                      ...
                      fill={isActive("/explore") && !postModal ? "#F62E8E" : "#ECEBED"}
                      stroke={isActive("/explore") && !postModal ? "#F62E8E" : "#ECEBED"}
                      stroke-width="0.5"
                    />
                  </svg>
                  EXPLORAR
              ...
              <NavLink className="w-full flex pl-5" onClick={handleModal}>
                <li
                  className={
                    postModal
                      ? "flex items-center gap-3 p-2 w-40 text-social-pink"
                ...
                >
                  ...
                  >
                    <path
                      ...
                      stroke={postModal ? "#F62E8E" : "#ECEBED"}
                      stroke-width="3"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
              ...
              <NavLink to="/notifications" className="w-full flex pl-5">
                <li
                  className={
                    isActive("/notifications") && !postModal
                      ? "flex items-center gap-3 p-2 text-social-pink"
                      : "flex items-center gap-3 p-2 opacity-20"
                  }
                >
                  <svg
                    width="36"
                  ...
                  >
                    <path
                      ...
                      stroke={
                        isActive("/notifications") && !postModal ? "#F62E8E" : "#ECEBED"
                      }
                      stroke-width="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"
