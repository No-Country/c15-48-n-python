  ...
  return (
    <nav className="h-full flex items-center justify-around px-4 w-full bottom-0 bg-black md:hidden">
      <ul className="flex items-center w-full justify-around">
        <li className={isActive("/") ? "opacity-100" : "opacity-20"}>
          <NavLink to="/">
            <svg
              width="25"
              height="25"
        ...
        <li className={isActive("/explore") ? "opacity-100" : "opacity-20"}>
          <NavLink to="/explore">
            <svg
              width="20"
              height="20"
        ...
        <li className={isActive("/notifications") ? "opacity-100" : "opacity-20"}>
        ...
        <li className={location.pathname.startsWith("/profile") ? "opacity-100" : "opacity-20"}>
                ...
                <g id="icon/profile">
                  <g id="g3">
                    <path
                      ...
                      stroke={location.pathname.startsWith("/profile") ? "#F62E8E" : "#ECEBED"}
                      stroke-width="1.5"
                    />
                    <path
                      id="path2-1-0"
